...
to insert bash continuation characters rather than starting a new apt-get statement.
"""
...
# V1.2 20110503GW Tested against 0.7.100.1 of python-apt and python 2.6.6 on Debian
# V1.1 20091028GW Commented and retested for python 2.6 and python-apt 0.7.9
# V1.0 20090515GW
###
...
if (debug > 2):
    ...
    count = 0
    lineout = "apt-get --no-act install "
